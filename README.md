...
```bash
curl -fsSL https://raw.githubusercontent.com/Rybens92/llama-installer/0539ad5/llama-installer.sh | bash -s -- --install
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Rybens92/llama-installer/0539ad5/llama-installer.sh | bash
```

**With options:**
```bash
# Preview what will be installed
curl -fsSL https://raw.githubusercontent.com/Rybens92/llama-installer/0539ad5/llama-installer.sh | bash -s -- -n

# Install in custom directory
curl -fsSL https://raw.githubusercontent.com/Rybens92/llama-installer/0539ad5/llama-installer.sh | bash -s -- -d /opt/bin

# Install specific version
curl -fsSL https://raw.githubusercontent.com/Rybens92/llama-installer/0539ad5/llama-installer.sh | bash -s -- -v b7411
```
...
curl -fsSL https://raw.githubusercontent.com/Rybens92/llama-installer/0539ad5/llama-installer.sh -o llama.sh
chmod +x llama.sh
